...
export let BIOIMAGES = new Map([
  ...
  ['lex', new BioImageData('assets/bioImages/lex.jpg', 'The annual battle of Lexington reenactment in Lexington, MA')],
  ['phl', new BioImageData('assets/bioImages/schoolofathens.jpg', 'Raphael\'s famous School of Athens painting depicting Plato and Aristotle. Plato points towards the sky in a nod to Platonian Idealism while Aristotle gestures towards the ground to remind us of his belief in an empirical reality.')],
